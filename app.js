      ...
      <section class="panel manual-panel">
        ...
        <section class="manual-toc" aria-labelledby="manual-toc-title">
          ...
          <ul>
            ...
            <li><a href="#manual-flow">二、基本使用流程</a></li>
            <li><a href="#manual-writing-note">三、寫札記</a></li>
            <li><a href="#manual-content-library">四、札記庫</a></li>
            <li><a href="#manual-selection-workbench">五、選稿編排</a></li>
            <li><a href="#manual-chapter-arrangement">六、整理章節</a></li>
            <li><a href="#manual-export">七、成書匯出</a></li>
            <li><a href="#manual-library">八、書櫃</a></li>
            <li><a href="#manual-reader">九、閱讀器</a></li>
            <li><a href="#manual-mobile">十、手機版使用提醒</a></li>
        ...
        <article class="manual-article">
          ...
          <section id="manual-flow" class="manual-section">
            ...
            <ol>
              ...
              <li>進入「札記庫」，用搜尋、日期、分類、標籤找到適合整理的文章。</li>
              <li>進入「選稿編排」，建立新的選稿編排，或從既有編排點選「開始編這本」。</li>
              <li>回到「札記庫」，勾選文章後加入目前正在編排的書稿。</li>
              <li>回到「選稿編排」，點選「整理章節」，調整順序、標題與是否列入目錄。</li>
              <li>點選「成書匯出設定」，補齊書名、作者、封面、前言等資訊。</li>
              <li>匯出 EPUB，下載檔案，或加入「書櫃」用內建閱讀器閱讀。</li>
            </ol>
            <p>「目前正在編排」是整個成書流程的工作狀態。札記庫的加入按鈕會把勾選文章加入這一份書稿。</p>
          </section>
          ...
          <section id="manual-content-library" class="manual-section">
            ...
            <p>每張札記卡片可勾選，也可點「編輯」回到寫札記修改。若卡片顯示「已在書中」，代表這篇札記已被收錄在目前正在編排的書稿中，系統會避免重複加入。</p>
            <p>札記庫上方會顯示目前狀態：</p>
            <ul>
          ...
          <section id="manual-chapter-arrangement" class="manual-section">
            <h2>六、整理章節</h2>
            <p>點「整理章節」會開啟章節整理彈窗。若整理的是目前正在編排的書稿，標題會顯示「目前選稿編排：{title}」。若整理的是其他書稿，標題會顯示「整理章節：{title}」，彈窗內也會提供「開始編這本」。</p>
            <p>章節整理中可以做這些事：</p>
            <ul>
              <li>修改章節標題。</li>
            ...
            <p>整理時建議先排出讀者容易理解的順序，再微調章節標題。手機版彈窗可上下滑動，儲存前請確認調整已完成。</p>
          </section>

          <section id="manual-export" class="manual-section">
            <h2>七、成書匯出</h2>
            <p>成書匯出從「選稿編排」進入。先在目前正在編排的卡片或章節彈窗中點「成書匯出設定」。</p>
            <p>成書匯出設定可補齊：</p>
            <ul>
              <li>書名與副標。</li>
              <li>作者。</li>
            ...
            <p>完成設定後，可以匯出 EPUB。匯出成功後，畫面會提供下載 EPUB、加入書櫃或開啟閱讀的動作。下載後的 EPUB 可用 iOS「書籍」、Android「Google Play 圖書」或其他 EPUB 閱讀器開啟。</p>
          </section>
          ...
          <section id="manual-library" class="manual-section">
            ...
            <ul>
              <li>閱讀：開啟內建閱讀器。</li>
              <li>下載：下載可保存或分享的 EPUB。</li>
              <li>匯入 EPUB：選擇安全、正常的 EPUB 檔加入書櫃。</li>
              <li>刪除或管理：移除不需要的書籍。</li>
          ...
          <section id="manual-reader" class="manual-section">
            <h2>九、閱讀器</h2>
            <p>從書櫃點「閱讀」會開啟閱讀器。閱讀器會顯示書名、章節內容、目前閱讀進度與頁碼。</p>
            <p>可以用以下方式操作：</p>
            <ul>
            ...
            <p>手機版閱讀器會把控制項收得比較精簡。若看不到目錄、搜尋或書籤按鈕，先點一下閱讀畫面讓功能按鈕顯示。</p>
          </section>

          <section id="manual-mobile" class="manual-section">
            <h2>十、手機版使用提醒</h2>
            <p>手機版底部導覽列固定在畫面底部，方便快速切換總覽、寫札記、札記庫、選稿編排、書櫃、操作手冊等功能。</p>
            <p>當功能項目較多時，底部導覽列可以左右滑動。若沒有看到管理後台或操作手冊，可在底部導覽列上左右滑動尋找。</p>
            <p>在手機上編輯札記、整理章節或設定成書資料時，建議先確認儲存成功再離開頁面。若頁面內容較長，可往下滑到底部確認按鈕沒有被底部導覽遮住。</p>
          </section>

          <section id="manual-account-data" class="manual-section">
            <h2>十一、帳號與資料</h2>
            <p>登入後，畫面會顯示帳號資訊與同步狀態。桌機可從側邊欄帳號卡進入「帳號設定」或「登出」，手機可從總覽或導覽中的帳號入口操作。</p>
