      ...
      <section class="panel manual-panel">
        ...
        <article class="manual-article">
          <section id="manual-purpose" class="manual-section">
            ...
            <p>使用者可以從一篇札記開始，逐步累積內容。當文章數量增加後，可以從札記庫搜尋、篩選並挑選適合的文章，加入目前正在編排的書稿，再整理章節順序，最後進入成書匯出，產生 EPUB 電子書。</p>
          ...
          <section id="manual-areas" class="manual-section">
            ...
            <ul>
              ...
              <li>編輯既有札記</li>
              <li>勾選適合成書的文章</li>
              <li>將文章加入目前正在編排的書稿</li>
            </ul>
            <p>札記庫的主要用途，是保存、搜尋、篩選、編輯與挑選原始文章。</p>
            <p>當某篇札記適合收進未來的書中，可以直接從札記庫勾選該篇文章，加入目前正在編排的書稿。</p>
            <h3>4. 選稿編排</h3>
          ...
          <section id="manual-recommendations" class="manual-section">
            ...
            <p>每週可以花一段時間打開札記庫。</p>
            <p>回顧最近寫過的內容。</p>
            <p>挑選較完整、較有主題性的文章，加入目前正在編排的書稿。</p>
            <p>這樣可以讓札記逐漸形成成書素材。</p>
            <h3>3. 每月成書整理方式</h3>
            <p>每月可以建立一份選稿編排。</p>
            <p>從札記庫挑選適合的文章加入編排。</p>
          ...
          <section id="manual-faq" class="manual-section">
            ...
            <p>札記儲存後會先留在札記庫。</p>
            <p>若要放進書中，需要先建立或選擇目前正在編排的書稿，再從札記庫勾選文章加入。</p>
          ...
          <section id="manual-habits" class="manual-section">
            ...
            <ul>
              ...
              <li>每週回顧札記庫，把成熟文章加入目前正在編排的書稿。</li>
              <li>每月建立或整理選稿編排。</li>
              <li>成書前先預覽內容與章節順序。</li>
          ...
          <section id="manual-example" class="manual-section">
            ...
            <ol>
              ...
              <li>前往「札記庫」，把適合的文章加入目前正在編排的書稿。</li>
