        ...
        <article class="manual-article">
          ...
          <section id="manual-writing-note" class="manual-section">
            ...
            <div class="manual-card-grid">
              ...
              <div class="manual-card"><h3>經文</h3><p>可以輸入經文範圍，也可以按「抓取經文」帶入內容。多處經文用分號分隔；抓取後可選擇同步放入全文，經文區會顯示已帶出幾處。手機上會用「同步放入全文」、「已帶出 1 處」、「多處用分號」等短句顯示。格式錯誤、找不到經文、網路不穩或資料暫時無法取得時，畫面會顯示中文提示。</p></div>
