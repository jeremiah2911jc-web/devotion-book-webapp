    ...
    section.innerHTML = `
      <section class="panel manual-panel">
        <section class="manual-hero">
          ...
          <p>這套系統幫助你把每天與神同行的領受、禱告、代禱、感恩、悔改、講道筆記與查經心得，整理成可以閱讀、可以下載、可以長期保存的電子書。</p>
        ...
        <article class="manual-article">
          <section id="manual-purpose" class="manual-section">
            <h2>一、靈修札記成書系統是什麼</h2>
            <p>靈修札記成書系統是一個陪你長期整理信仰文字的工具。你可以把每日靈修、主日信息、小組查經、講道筆記、禱告、代禱、感恩、悔改、生命經歷與個人回顧寫下來，日後再慢慢整理、搜尋、分類與編排。</p>
          ...
          <section id="manual-dashboard" class="manual-section">
            ...
            <p>若今日默想有內容，可以從卡片上的「寫成札記」開始記錄今天的回應；平常則可使用側邊欄或手機底部導覽進入寫札記、札記閱讀、札記庫與選稿編排。</p>
          ...
          <section id="manual-writing-note" class="manual-section">
            ...
            <div class="manual-card-grid">
              ...
              <div class="manual-card"><h3>經文</h3><p>可以填經文範圍，也可以按「抓取經文」帶入內容。格式錯誤、找不到經文、網路不穩或資料來源暫時異常時，畫面會以中文提示說明下一步。</p></div>
          ...
          <section id="manual-prayer-review" class="manual-section">
            <h2>五、禱告與回顧</h2>
            <p>「禱告」是獨立於單篇札記之外的長期禱告紀錄。手機底部導覽與桌機側欄都可進入「禱告」，頁面名稱是「禱告與回顧」。預設不會展開表單，點「新增禱告」後才開始填寫。</p>
